...
\usepackage[singlelinecheck=false, justification=centering]{subcaption}
...
\tikzset{
  ...
  every state/.style={minimum size=0.3cm}, ->,>=stealth}
...
\input{sections/tensor_product_algo}
\input{sections/bidirected_dyck}
\input{sections/dyck_1}
\input{sections/dyck_1_1}
